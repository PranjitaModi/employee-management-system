    ...
    <div className="flex min-h-screen w-screen items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-2xl shadow-2xl p-8 md:p-10">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1.5 font-medium">Synergy & Operations Hub</p>
        </div>
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          <div>
            ...
            <input
              ...
              type="email"
              placeholder="director@zenflow.com"
            />
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-800/60 text-center">
          ...
          <div className="flex flex-col gap-1 text-[11px] text-slate-400">
            <p><span className="font-semibold text-indigo-400">Director:</span> director@zenflow.com</p>
            <p><span className="font-semibold text-violet-400">Associate:</span> e@e.com (Alex) / sophia@zenflow.com</p>
          </div>
        </div>
